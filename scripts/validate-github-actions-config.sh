...
if [ "$SCENARIO" = "provision" ]; then
  ...
  require_nonempty "CAPI_CORE_PROVIDER_VERSION" "${CAPI_CORE_PROVIDER_VERSION:-}"
  require_nonempty "CAPI_BOOTSTRAP_PROVIDER_VERSION" "${CAPI_BOOTSTRAP_PROVIDER_VERSION:-}"
  require_nonempty "CAPI_CONTROL_PLANE_PROVIDER_VERSION" "${CAPI_CONTROL_PLANE_PROVIDER_VERSION:-}"
  require_nonempty "CAPI_IPAM_PROVIDER_VERSION" "${CAPI_IPAM_PROVIDER_VERSION:-}"
  require_nonempty "CAPO_PROVIDER_VERSION" "${CAPO_PROVIDER_VERSION:-}"
