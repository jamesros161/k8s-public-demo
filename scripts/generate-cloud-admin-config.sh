...
CAPI_CLUSTERCTL_VERSION="$(prompt_default "CAPI_CLUSTERCTL_VERSION" "v1.11.3")"
...
CAPI_CORE_PROVIDER_VERSION=v1.11.0
CAPI_BOOTSTRAP_PROVIDER_VERSION=v1.11.0
CAPI_CONTROL_PLANE_PROVIDER_VERSION=v1.11.0
CAPI_IPAM_PROVIDER_VERSION=v1.1.0-rc.1
CAPO_PROVIDER_VERSION=v0.14.2
